...
import { useFetchStokvelQuery } from "@/features/stokvel/stokvel-api";
...
export default function GroupDetailsPage({
  params,
}: GroupDetailsPageProps): React.ReactElement {
  ...
  // const { stokvel: groupDetails, members } = data || {};
  // groupDetails['members'] = members?.users?.length || 0;

  const groupDetails = {
    members: data?.members?.users?.length || 0,
    ...data?.stokvel,
  }
