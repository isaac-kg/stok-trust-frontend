...
import { useGetStokvelByIdQuery } from "@/features/stokvel/stokvel-api";
...
export default function StokvelOverview({ id }: { id: string }): React.ReactElement {
	const { data: stokvel, isLoading: isLoadingStokvel, error: errorStokvel } = useGetStokvelByIdQuery(id);
